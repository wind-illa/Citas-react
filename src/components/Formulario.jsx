  ...
  return (
    <div className="md:w-1/2 lg:w-2/5">
      ...
      <form className="bg-white shadow-md rounded-lg py-10 px-5 mb-10">
        ...
        <div className="mb-5">
          <label htmlFor="propietario" className="block text-gray-700 uppercase font-bold">Nombre Popietario</label>
          < input
            id="propietario"
            type="text"
        ...
        <input
          type="submit"
          className="bg-indigo-600 w-full p-2 text-white uppercase font-bold hover:bg-indigo-700 rounded-md cursor-pointer transition-all"
